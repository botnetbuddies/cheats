...
```sh title:"Devious-WinRM WinRM shell authenticated with password"
...
```sh title:"Devious-WinRM WinRM pass-the-hash shell with NT hash"
...
```sh title:"Devious-WinRM WinRM shell authenticated with ccache TGT"
