...
```sh title:"Ligolo Run agent on Windows pivot, ignore self-signed cert"
...
```sh title:"Ligolo Run agent on Linux pivot, ignore self-signed cert"
...
```sh title:"Ligolo 240.0.0.1/32 magic route, expose attacker loopback to agent"
...
```sh title:"Ligolo Default reverse forward, attacker:11601 onto pivot:11601"
...
```sh title:"Ligolo Custom reverse forward, choose pivot port and attacker port"
